...
<div id="logo" class="container">
  <a href="../index.html" class="button" style="font-size:200%">Back</a>
   <h1>物種資料庫<span>Loacl web system</span><h1>List all libraries</h1></h1>
  </br>
</div>
...
<div id="wrapper" class="container">
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<thead>";
            echo "<td style=\"font-size:150%\">ID</td>";
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td style=\"font-size:100%\">" . $row["ID"]. "</td>";
